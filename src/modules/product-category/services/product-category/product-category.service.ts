...
export class ProductCategoryService {
    ...
    async createProductCategory(productCategoryDetails: CreateProductCategoryParams) {
    ...
    findProductCategory() {
        ...
        return this.productCategoryRepository.find(); // Fetch customers with their profiles
    }

    findProductCategoryById(id: string) {
        // Logic to find a customer by ID
        return this.productCategoryRepository.findOne({ where: { id }}); // Fetch customer with their profile
    }
